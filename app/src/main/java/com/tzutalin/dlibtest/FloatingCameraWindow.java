...
Modification history :  By Roopansh Bansal 11/04/2017
                            By Shubham Singhal 06/04/2017
...
//floating camera window to handle the floating window in the UI
public class FloatingCameraWindow {
    ...
    private final class FloatCamView extends FrameLayout {
        ...
        //functions to handle touch events on floating windows
        @Override
